                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control timepicker" name="return_date" type="date" value="{{ old('return_date', @$saleReturn->return_date) }}" autocomplete="off">
                            </div>
                        </div>
                            ...
                            <table class="productTable table border">
                                <thead class="border bg--dark">
                                    <tr>
                                        ...
                                        <th>@lang('Price')</th>
                                        @if(collect($detailsData)->contains(fn($item) => strtolower($item->product->unit->name) === 'kg'))
                                        <th>@lang('Net Weight (kg)')</th>
                                        @endif
                                        <th>@lang('Total')</th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-start">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control form-control-sm quantity" name="products[{{ $loop->index }}][quantity]" data-qty="{{ @$return->quantity }}" type="number" value="{{ $edit ? $return->quantity : 0 }}" required>
                                        ...
                                        {{-- Only show Net Weight if unit is KG --}}
                                        @if(strtolower($return->product->unit->name) === 'kg')
                                        <td>
                                            <input type="number" name="products[{{ $loop->index }}][net_weight]" class="form-control form-control-sm" step="1" value="{{ old("products.$loop->index.net_weight", $return->net_weight ?? '') }}">
                                        </td>
                                        @endif

                                        @php
                                        $unitName = strtolower($return->product->unit->name);
                                        $price = $return->price;
                                        $quantity = $edit ? $return->quantity : 0;
                                        $netWeight = old("products.$loop->index.net_weight", $return->net_weight ?? 0);

                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary cuModalBtn" data-resource="{{ $unit }}"
                                                    data-modal_title="@lang('Update Unit')">
                                                    <i class="la la-pencil"></i>@lang('Edit')
                                                </button>
                                                @permit('admin.product.unit.delete')
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-danger @if ($unit->products_count) disabled @endif confirmationBtn"
                                                        data-question="@lang('Are you sure to delete this unit?')" data-action="{{ route('admin.product.unit.delete', $unit->id) }}">
...
@push('breadcrumb-plugins')
    ...
    @endpermit
    @permit('admin.product.unit.import')

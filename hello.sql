...
INSERT INTO `admins` (`id`, `role_id`, `name`, `email`, `mobile`, `username`, `image`, `password`, `status`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 0, 'Super Admin', 'admin@site.com', NULL, 'admin', '668faec6ec6401720692422.png', '$2y$12$UUyNnwC9xYZNPWVXLZLcbOq2C5bRqMUtZq8YSnnG7TpBCkwlBJ9QK', 1, 'JmxdPhgysjZMN2EacgMB1dqFTzYgRC3sOCImVrCTGOz0cdWqIiC7BzjuYdK0', NULL, '2025-03-22 20:28:24');
...
-- Dumping structure for table dewanchemicalokr.banks
CREATE TABLE IF NOT EXISTS `banks` (
  ...
  `raast_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping structure for table dewanchemicalokr.bank_transactions
CREATE TABLE IF NOT EXISTS `bank_transactions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `bank_id` bigint unsigned NOT NULL,
  `transactable_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `transactable_id` bigint unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `bank_transactions_transactable_type_transactable_id_index` (`transactable_type`,`transactable_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table dewanchemicalokr.bank_transactions: ~0 rows (approximately)
...
-- Dumping structure for table dewanchemicalokr.cache
...
-- Dumping data for table dewanchemicalokr.cache: ~0 rows (approximately)

-- Dumping structure for table dewanchemicalokr.cache_locks
...
-- Dumping data for table dewanchemicalokr.cache_locks: ~0 rows (approximately)
...
-- Dumping structure for table dewanchemicalokr.failed_jobs
...
-- Dumping data for table dewanchemicalokr.failed_jobs: ~0 rows (approximately)
...
-- Dumping structure for table dewanchemicalokr.jobs
...
-- Dumping data for table dewanchemicalokr.jobs: ~0 rows (approximately)

-- Dumping structure for table dewanchemicalokr.job_batches
...
-- Dumping data for table dewanchemicalokr.job_batches: ~0 rows (approximately)

-- Dumping structure for table dewanchemicalokr.migrations
...
-- Dumping data for table dewanchemicalokr.migrations: ~5 rows (approximately)
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
    (1, 'create_users_table', 1),
    (2, 'create_cache_table', 1),
    (3, 'create_jobs_table', 1),
    (4, 'create_banks_table', 1),
    (5, 'create_bank_transactions_table', 1),
    (6, 'create_actions_table', 1),
    (7, 'create_adjustments_table', 1),
    (8, 'create_adjustment_details_table', 1),
    (9, 'create_admins_table', 1),
    (10, 'create_brands_table', 1),
    (11, 'create_categories_table', 1),
    (12, 'create_customers_table', 1),
    (13, 'create_customer_payments_table', 1),
    (14, 'create_expenses_table', 1),
    (15, 'create_expense_types_table', 1),
    (16, 'create_products_table', 1),
    (17, 'create_product_stocks_table', 1),
    (18, 'create_roles_table', 1),
    (19, 'create_sales_table', 1),
    (20, 'create_sale_details_table', 1),
    (21, 'create_suppliers_table', 1),
    (22, 'create_supplier_payments_table', 1),
    (23, 'create_transfers_table', 1),
    (24, 'create_transfer_details_table', 1),
    (25, 'create_units_table', 1),
    (26, 'create_warehouses_table', 1),
    (27, 'create_admin_notifications_table', 1),
    (28, 'create_admin_password_resets_table', 1),
    (29, 'create_cache_locks_table', 1),
    (30, 'create_failed_jobs_table', 1),
    (31, 'create_general_settings_table', 1),
    (32, 'create_job_batches_table', 1),
    (33, 'create_migrations_table', 1),
    (34, 'create_notification_logs_table', 1),
    (35, 'create_notification_templates_table', 1),
    (36, 'create_password_resets_table', 1),
    (37, 'create_password_reset_tokens_table', 1),
    (38, 'create_permissions_table', 1),
    (39, 'create_permission_role_table', 1),
    (40, 'create_purchase_details_table', 1),
    (41, 'create_purchases_table', 1),
    (42, 'create_purchase_returns_table', 1),
    (43, 'create_purchase_return_details_table', 1),
    (44, 'create_sale_returns_table', 1),
    (45, 'create_sale_return_details_table', 1),
    (46, 'create_sessions_table', 1),
    (47, 'create_update_logs_table', 1),
    (48, 'create_extensions_table', 1);
...
-- Dumping structure for table dewanchemicalokr.password_reset_tokens
...
-- Dumping data for table dewanchemicalokr.password_reset_tokens: ~0 rows (approximately)
...
-- Dumping structure for table dewanchemicalokr.sessions
...
-- Dumping data for table dewanchemicalokr.sessions: ~0 rows (approximately)
...
-- Dumping structure for table dewanchemicalokr.users
...
-- Dumping data for table dewanchemicalokr.users: ~0 rows (approximately)
